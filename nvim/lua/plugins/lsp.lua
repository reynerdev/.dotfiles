...
return {
	...
	},
	{
		...
		dependencies = {
			...
			-- NOTE: cmp-nvim-lsp depends on hrsh7th/nvim-cmp (require("cmp")).
			-- We use blink.cmp, so keep this commented to avoid module errors.
		...
		config = function()
			...
			-- NOTE: cmp-nvim-lsp requires hrsh7th/nvim-cmp; keep this disabled while using blink.cmp.
			-- else
